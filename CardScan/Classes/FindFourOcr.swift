...
struct FindFourOcr {
    ...
    static func initializeModels() {
        if FindFourOcr.recognizeModel == nil {
            guard let fourRecognizeUrl = CSBundle.compiledModel(forResource: fourRecognizeResource, withExtension: fourRecognizeExtension) else {
        ...
        if FindFourOcr.detectModel == nil {
            guard let findFourUrl = CSBundle.compiledModel(forResource: findFourResource, withExtension: findFourExtension) else {
